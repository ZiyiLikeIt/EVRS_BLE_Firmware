...
build-647843775:
	@$(MAKE) --no-print-directory -Onone -f TOOLS/subdir_rules.mk build-647843775-inproc

build-647843775-inproc: C:/ti/ble_sdk_2_02_02_25/ble_examples/examples/cc2650lp/simple_central/ccs/config/app_ble.cfg
	@echo 'Building file: "$<"'
...
configPkg/linker.cmd: build-647843775 C:/ti/ble_sdk_2_02_02_25/ble_examples/examples/cc2650lp/simple_central/ccs/config/app_ble.cfg
configPkg/compiler.opt: build-647843775
configPkg/: build-647843775
